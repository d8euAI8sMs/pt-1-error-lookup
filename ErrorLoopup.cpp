...
// ErrorLoopup.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CErrorLoopupApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CErrorLoopupApp

CErrorLoopupApp::CErrorLoopupApp()
{
...
// Единственный объект CErrorLoopupApp

CErrorLoopupApp theApp;


// инициализация CErrorLoopupApp

BOOL CErrorLoopupApp::InitInstance()
{
